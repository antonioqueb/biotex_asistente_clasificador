# Asistente Clasificador — especificación implementada

Módulo `biotex_asistente_clasificador` 19.0.1.0.0 · 12 de septiembre de 2026 · requiere `biotex_catalog` 19.0.3.5.2.
...
| K | Abrir "Asistente de clasificación" (base). | No lista ni abre las sesiones de marca por producto; su flujo no cambia. |
